...
class GrowthRateManipultor(QtGui.QWidget):
    ...
    def __init__(self):
      ...
      self.growth_rate_dict = { key: -0.1 for key in region_keys }
    ...
    def create_slider(self, layout, number):
      ...
      valueLabel.setText(str(-500 / 10000.))
    ...
    def change_value(self, slider_number, value):
      self.growth_rate_dict[slider_number] = -( value / 10000. )
      self.send_rates()
...
if __name__ == '__main__':
  ...
  nett.initialize('tcp://127.0.0.1:2006')
  main()    
